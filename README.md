...
[![stable v1.9.5](https://img.shields.io/badge/stable-v1.9.5-E5B8BE?style=flat-square)](https://github.com/wkx176617-sys/GIT/releases/tag/v1.9.5)
...
> 当前推荐稳定版本：`v1.9.5`。生产节点只使用稳定标签，不直接部署开发中的 `main`。
